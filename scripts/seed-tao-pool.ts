/**
 * Seed TAO/USD pool with USD0 liquidity.
 * Run: npx hardhat run scripts/seed-tao-pool.ts --network baseSepolia
 */
...
const TAO_MARKET = "0x24061f45f954D880dCa0Ce122FFA60Cfd5447B5A";
const USD0 = "0x3ae4474579d24a743c9016F017e76185A834d837";

const DEPOSIT_AMOUNT = ethers.utils.parseUnits("500000", 6); // $500k USD0
...
async function main() {
  ...
  // Create deposit
  console.log("\nCreating deposit of", ethers.utils.formatUnits(DEPOSIT_AMOUNT, 6), "USD0 into TAO/USD pool...");
