...
library SwapPricingUtils {
    ...
    function getSwapFees(
        ...
        fees.feeAmountForPool = feeAmount;
    ...
    function emitSwapFeesCollected(
        ...
        eventData.uintItems.setItem(3, "uiFeeReceiverFactor", fees.uiFeeReceiverFactor);
        eventData.uintItems.setItem(4, "uiFeeAmount", fees.uiFeeAmount);
