...
import {
  BORROWING_FEE_SECONDARY_RECEIVER_FACTOR,
  LIQUIDATION_FEE_SECONDARY_RECEIVER_FACTOR,
  POSITION_FEE_SECONDARY_RECEIVER_FACTOR,
  SWAP_FEE_SECONDARY_RECEIVER_FACTOR,
} from "./keys";
...
export const EXCLUDED_CONFIG_KEYS = {
  ...
  SWAP_FEE_SECONDARY_RECEIVER_FACTOR: true,
  FEE_BATCH_LIST: true,
  ...
  LATEST_ADL_AT: true,
  LEVERAGE_LADDER_TIER_COUNT: true,
  LEVERAGE_LADDER_MAX_NOTIONAL: true,
  LEVERAGE_LADDER_MAX_LEVERAGE: true,
  MARKET_LIST: true,
